            ...
            <div class="col s12 m4 l4">
                <div id="profile-card" class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        <img class="activator" src="<?= base_url('theme/');?>images/gallary/3.png" alt="user bg">
                    </div>
                    <div class="card-content">
                        <img src="<?= base_url('theme/');?>images/avatar/avatar-7.png" alt="" class="circle responsive-img activator card-profile-image cyan lighten-1 padding-2">
